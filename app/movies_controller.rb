...
def can_be_found_updated_and_saved
  ...
  rand_movie = Movie.find_by(title: "Awesome Flick")
  rand_movie.title = "Even Awesomer Flick"
  rand_movie.save
  rand_movie
end
...
def can_update_using_update_method
  ...
  other_movie = Movie.find_by(title: "Wat?")
  other_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  another_movie = Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  Movie.destroy(another_movie.id)
  # __
end
